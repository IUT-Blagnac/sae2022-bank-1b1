...
- La spécification finalisées de la version 2
- La création de super options pour le chef d'agence

Dans cette version, il y a aura l'ajout d'un batch ou traitement par lots qui réalisera certaines opérations automiquement, sans l'intervention d'une personne :
