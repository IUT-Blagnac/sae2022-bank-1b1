...
public class DailyBankState {
	...
	/**
	 * Permet définir l'employé courant
	 * @param employeActif employé é définir courant
	 */
	...
	/**
	 * Permet de savoir si l'employé courant est chef d'agence
	...
	/**
	 * Permet de définir si l'employé courant est chef d'agence
	 * @param droitsAccess chaine de caractére contenant le droit d'accés pour le chef d'agence
	 */
