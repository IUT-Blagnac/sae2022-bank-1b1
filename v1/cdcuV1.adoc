...
Cependant, il existe quand même différent profils d'utilisateurs qui sont les Guichetier et le Chef d'agence. Le guichetier peut créer et gérer les client. Le Chef d'agence est un guichetier qui peut rendre inactif un client.
